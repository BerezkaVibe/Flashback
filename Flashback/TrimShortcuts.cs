...
internal enum TrimAction
{
    ...
    ZoomIn, ZoomOut, ZoomToggle, Snapshot, Export, OpenVideo, SaveProject, ShortcutGuide, CutTool, SpeedTool, ZoomTool, TextTool, ImageTool, CopyPart, PastePart, ShapeTool, VolumeTool, SoundTool, DrawTool, FreezeFrame, Fullscreen
}
...
internal static class TrimShortcuts
{
    internal static readonly TrimShortcut[] All =
    {
        ...
        new(TrimAction.ImageTool,"Editing","File tool: pictures, GIFs, videos and music (Esc leaves)","P"),
        new(TrimAction.ShapeTool,"Editing","Shapes and lines tool, with shapes (Esc leaves)","D"),
        new(TrimAction.DrawTool,"Editing","Shapes and lines tool, drawing freehand, straight or joined lines (Esc leaves)","W"),
        new(TrimAction.FreezeFrame,"Editing","Freeze frame at the playhead","F"),
        new(TrimAction.VolumeTool,"Editing","Volume tool, on the audio lanes (Esc leaves)","V"),
        new(TrimAction.SoundTool,"Editing","Sound tool, adds music or sounds (Esc leaves)","N"),
        new(TrimAction.CopyPart,"Editing","Copy the clicked timeline part","Ctrl+C"),
        new(TrimAction.PastePart,"Editing","Paste it at the playhead","Ctrl+V"),
